...
args.save = '../../experiments/sota/{}/eval/lr{}-{}-{}'.format(
...
def main():
    ...
    if args.dataset == 'cifar10':
        ...
        dir_path = f'/home/sofiacasarin/data/'
  ...
  #  scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(
   #     optimizer, float(args.epochs))
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        ## scheduler
        scheduler.step()
       # if epoch == 29 or epoch == 59 or epoch == 99 or epoch == 119:
        #    lr = lr * 0.2
...
if __name__ == '__main__':
    main()
    print('\n Esperimento andato con R18, 8 segmenti, VH medie traslazioni, 120 epoche, '
          'lr step, lr = 0.05, wd = defaults decreased by a factor of 5 every 30. Btahc 128, GSF100%')
