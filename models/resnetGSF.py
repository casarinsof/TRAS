...
from utils.reverse_atrous import *
# ------------ todo bisogna aggiungere da qualche parte le trasformazioni Grouped?
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.gsf = GSF(fPlane=planes * self.expansion, num_segments=num_segments, gsf_ch_ratio=gsf_ch_ratio)
...
def resnet101(pretrained=False, progress=True, num_segments=4, gsf_ch_ratio=25, **kwargs):
